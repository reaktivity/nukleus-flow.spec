...
public class ClientIT
{
    ...
    @Specification({
        ...
        "${client}/client.connected/server"})
    ...
    @Specification({
        ...
        "${client}/client.sent.data/server"})
    ...
    @Specification({
        ...
        "${client}/client.sent.flush/server"})
    ...
    @Specification({
        ...
        "${client}/client.sent.challenge/server"})
    ...
    @Specification({
        ...
        "${client}/client.received.data/server"})
    ...
    @Specification({
        ...
        "${client}/server.sent.flush/server"})
    ...
    @Specification({
        ...
        "${client}/server.sent.challenge/server"})
    ...
    @Specification({
        ...
        "${client}/client.sent.and.received.data/server"})
